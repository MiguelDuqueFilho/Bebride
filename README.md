...
Once this structure is replicated or cloned with these files, and Docker installed locally, you can simply run "docker-compose up" from the root of the project to run this., and point your browser (or curl) to http://localhost:8080 to see this site. We will get into what "docker-compose" is, and what makes up this basic demonstration in the following sections!
